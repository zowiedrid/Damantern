                ...
                {{-- <div class="px-6 pt-6 2xl:w-1/3">
                    ...
                    <form class="flex items-center gap-2">
                        <x-text-input id="search" name="search" type="text" class="w-full"
                            placeholder="Pencarian keperluan dan status ..." value="{{ request('search') }}" autofocus />
                ...
                <div class="p-6 text-xl text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <x-create-button href="{{ route('izin.create') }}" />

                            {{-- <a class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" href="{{ route('izin.create') }}">Ajukan Izin</a> --}}
